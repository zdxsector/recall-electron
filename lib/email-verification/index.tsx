...
const EmailVerification: FunctionComponent<Props> = ({
  ...
  const sendVerifyUrl: string = `https://app.recall.com/account/verify-email/${base64EncodedEmail}`;
  ...
  const displayEmailConfirm = (
    <Fragment>
      ...
      <p>You are registered with Recall using the email:</p>
      ...
      <div className="email-verification__button-row button-borderless">
        <a
          target="_blank"
          rel="noreferrer"
          href="https://app.recall.com/settings"
