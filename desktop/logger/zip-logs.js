...
module.exports = function (window) {
    ...
    function () {
      dialog.showMessageBox(window, {
        ...
        message:
          ...
          `${path.basename(file)}`,
        detail:
          'For help with an issue, please contact support@recall.com and share your logs.',
      });
    };
  ...
  const onError = (error) =>
    dialog.showMessageBox(window, {
      ...
      detail:
        'Please contact support@recall.com and mention the error details below:' +
        '\n\n' +
        error.stack +
        '\n\n' +
        'System info: ' +
  ...
  try {
    ...
    const dst = path.join(desktop, `recall-${timestamp}.zip`);
