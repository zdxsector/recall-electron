...
case $1 in
  ...
  "staging")
    ...
    WEB_APP_URL='https://recall-staging.go-vip.net'
    APP_ENGINE_URL='https://staging.recall.com'
    ;;

  "develop")
    COMMIT_BRANCH='webapp-develop'
    WEB_APP_URL='https://recall-develop.go-vip.net'
    APP_ENGINE_URL='https://develop.recall.com'
    ;;

  "production")
    COMMIT_BRANCH='webapp'
    WEB_APP_URL='https://recall.go-vip.co'
    APP_ENGINE_URL='https://app.recall.com'
    ;;
...
# Setup config
json_string=$(printf '{"app_id": "chalk-bump-f49", "app_key": "12345", "development": false, "wpcc_client_id": "0", "wpcc_redirect_url": "https://recall.com", "is_app_engine": true, "web_app_url": "%s", "app_engine_url": "%s"}' "$WEB_APP_URL" "$APP_ENGINE_URL")
